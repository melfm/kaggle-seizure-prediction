...
class DataLoaderTest(unittest.TestCase):
    ...
    def test_data_loader(self):
        ...
        self.assertTrue(os.path.isdir(base_dir_train), 'Dataset dir not found')
        ...
        eeg_data, _, _ = self.ds.get_X_from_files(
    ...
    def test_evaluation_loader(self):
        ...
        self.assertIsInstance(y_train_eval_sampl[0], float)
